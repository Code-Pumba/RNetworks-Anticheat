...
export class Application {
    ...
    async start() {
        if (this.running !== null && this.resolve !== null) {
            this.logger.error('rlife_core applicasion already running');
        ...
        addEventListener('rlife_core.__internal__.stop_application', this.onStopCallback, false);
    ...
    async stop() {
        if (this.running === null || this.resolve === null) {
            this.logger.error('rlife_core application is not running');
    ...
    private onStop() {
        ...
        removeEventListener('rlife_core.__internal__.stop_application', this.onStopCallback);
    }
}
